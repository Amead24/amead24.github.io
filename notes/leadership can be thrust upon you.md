There's a lot of moving pieces to keep track of in such an industry and it'll be hard to break down a large community project into smaller actionable pieces when so much relies on other individuals.
